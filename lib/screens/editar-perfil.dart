...
class _EditarPerfilScreenState extends State<EditarPerfilScreen> {
  ...
  Future<void> _salvarDados() async {
    ...
    try {
      ...
      if (docId != null && docId.isNotEmpty) {
        final docRef = FirebaseFirestore.instance.collection('pessoas').doc(docId);

        final telefoneFormatado = formatarTelefoneParaSalvar(_telefoneController.text);
                  ...
                  child: ListView(
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (!_loginGoogle && (value == null || !value.contains('@'))) {
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (!_loginGoogle && (value == null || value.isEmpty)) {
